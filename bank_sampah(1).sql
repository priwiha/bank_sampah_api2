...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 16, 2024 at 11:20 PM
...
(6, 'cek kategori', '2', 'adm', NULL, '2024-03-14 07:23:43', NULL);
...
(30, 'member3', 'MBD26755c69d7', 'ketigaaaax', NULL, '02138213210', 'keti@ga.xa', 19995, 'Y', 'Register', 'tester', '2024-02-26 07:07:50', '2024-03-13 03:06:58'),
...
(36, 'mems', 'MBD15bb3', 'asdasfa', NULL, '092183214', 'mm@masd.as', 3490000, 'Y', 'Register', 'adm', '2024-03-08 08:50:04', '2024-03-14 08:36:31'),
(37, 'cek111', 'MBD2d16f', 'cek', NULL, '0813412412', 'ce@k.kk', 0, 'Y', 'Register', NULL, '2024-03-14 07:21:25', NULL);
...
(8, 6, NULL, 1500.00, 2, '2024-03-14 00:00:00', NULL, 'Y', 'adm', NULL, '2024-03-14 07:24:02', NULL);
...
(30, '2024-03-01', 'MBD26755c69d7', 'member3', 2, NULL, 10, 1, 2000.00, 20000.00, 'adm', NULL, '2024-03-01 07:42:59', NULL),
(31, '2024-03-12', 'MBD15bb3', 'mems', 1, NULL, 500, 2, 5000.00, 2500000.00, 'adm', NULL, '2024-03-12 06:57:33', NULL),
(32, '2024-03-14', 'MBD15bb3', 'mems', 1, NULL, 200, 2, 5000.00, 1000000.00, 'adm', NULL, '2024-03-14 08:36:31', NULL);
...
INSERT INTO `trredeem` (`idredeem`, `membercode`, `userid`, `redeemamt`, `redeemdate`, `approveddate`, `userapproved`, `inuserid`, `chuserid`, `indate`, `chdate`) VALUES
(1, 'MBD15bb3', 'mems', 5000, '2024-03-13', '2024-03-13', 'tester', 'tester', NULL, '2024-03-13', NULL),
(2, 'MBD15bb3', 'mems', 5000, '2024-03-14', '2024-03-14', 'adm', 'adm', NULL, '2024-03-14', NULL);
...
(65, 'mems', 'asdasfa', '092183214', 'mm@masd.as', NULL, '4171ebe182de4eb7d680688a028e33e2', NULL, '2', 'Y', '2024-03-08 01:50:04', NULL),
(66, 'cek111', 'cek', '0813412412', 'ce@k.kk', NULL, '0a7a408828d32329d6c665a3837c81bd', NULL, '2', 'Y', '2024-03-14 00:21:25', NULL);
...
--
ALTER TABLE `mtprice`
  MODIFY `idprice` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
...
--
ALTER TABLE `trgrbres`
  MODIFY `idgrb` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=33;

--
-- AUTO_INCREMENT for table `trredeem`
--
ALTER TABLE `trredeem`
  MODIFY `idredeem` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
